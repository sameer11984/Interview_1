...
public class BerlinClockFixture {
    ...
    @When("the sec is $sec")
    public void whenTheSecIs(int sec) {
        this.sec = sec;
    }

    @Then("the yellow light should look like $")
    public void thenTheYellowLightShouldLookLike(String yellowLight) {
        assertThat(berlinClock.getSeconds(sec)).isEqualTo(yellowLight);
    }
}
